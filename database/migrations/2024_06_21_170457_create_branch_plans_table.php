...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('branch_plans', function (Blueprint $table) {
            ...
            $table->boolean('branch_plan_is_active')->nullable();
            $table->timestamps();
            $table->softDeletes();
            $table->unsignedInteger('created_by')->nullable()->index('fk_branch_plans_created_by');
            $table->unsignedInteger('deleted_by')->nullable()->index('fk_branch_plans_deleted_by');
            $table->unsignedInteger('updated_by')->nullable()->index('fk_branch_plans_updated_by');
        });
    }
