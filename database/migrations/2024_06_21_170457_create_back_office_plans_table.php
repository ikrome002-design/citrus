...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('back_office_plans', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->unsignedInteger('account_type_id')->nullable()->unique('account_type_id');
            ...
            $table->timestamps();
            $table->softDeletes();
            $table->unsignedInteger('created_by')->nullable()->index('fk_back_office_plans_created_by');
            $table->unsignedInteger('deleted_by')->nullable()->index('fk_back_office_plans_deleted_by');
            $table->unsignedInteger('updated_by')->nullable()->index('fk_back_office_plans_updated_by');
        });
    }
    ...
    {
        Schema::dropIfExists('back_office_plans');
    }
};
