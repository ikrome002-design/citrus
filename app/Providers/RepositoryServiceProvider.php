...
class RepositoryServiceProvider extends ServiceProvider
{
    public function register()
    {
        ...
        $this->app->bind(
            FeatureSettingRepositoryInterface::class,
            FeatureSettingRepository::class
        );

        $this->app->bind(
            BannerSettingRepositoryInterface::class,
            BannerSettingRepository::class
        );
        ...
        $this->app->bind(
            MembershipVarientRepositoryInterface::class,
            MembershipVarientRepository::class
        );
        ...
        $this->app->bind(
            FooterRepositoryInterface::class,
            FooterRepository::class
        );
