...
class MerchantDashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        $shops =  DB::table('shops')
            ->join('business_types', 'shops.title', '=', 'business_types.id')
            ->select('business_types.title AS business_title', 'business_types.id AS bid', 'shops.*')
        ...
        return view('merchant.dashboard', ["vendor_msg" => $vendor_msg, "ddate" => $ddate, "payout" => $payout, "product" => $product, "totalorder" => $totalorder, "total" => $total, "orders_count" => $orders_count, "best_product" => $best_product, "vendor_msg_count" => $vendor_msg_count, "shops" => $shops, "plans" => $plans, "newData" => $newData]);
    }
