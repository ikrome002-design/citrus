...
class VendorDashboardController extends Controller
{
   ...
   /**
    ...
    public function staff_index()
    {
      ...
      $list=DB::table('employees')->where('merchant_id', auth('vendor')->user()->id)->where('shop_id', NULL)->orderBy('id', 'desc')->get();
     ...
     public function shop_staff_index(int $id)
    {
       ...
       // $list = $this->employeeRepo->listEmployees('created_at', 'desc');
      $list=DB::table('employees')->where('merchant_id', auth('vendor')->user()->id)->where('shop_id', $id)->orderBy('id', 'desc')->get();
