                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    { 
                                        ...
                                        <a title="Show order" href="@if(isset(auth('employee')->user()->id)){{ route('admin.products.edit', $order->products[$i]['id']) }} @elseif(isset(auth('vendor')->user()->id)){{ route('products.edit', $order->products[$i]['id']) }}@endif">{{ $order->products[$i]['sku'] }}<br></a>
                                    <?php }?>
                                </td>
