            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-12">
                    <div class="dashboard-admin-info">
                        <h2 class="top-heading">Hi <?php echo auth('employee')->user()->name;?>,  </h2>
                        ...
                        <div class="card-body shadow-sm">
                            ...
                            <div class="row">
                                <div class="col d-flex justify-content-between">
                                    <h2 class="font-weight-bold mb-0 top-heading align-self-center">$ {{$q }}</h2>
                 ...
                 <div class="col-md-12 col-lg-6 col-xl-4 col-sm-12">
                    <div class="card dashboard-top-plan">
                        <div class="card-body shadow-sm">
                            ...
                            <div class="row">
                                <div class="col d-flex justify-content-between">
                                    <h2 class="font-weight-bold top-heading mb-0 align-self-center">{{ $orders_count }}</h2>
                                     <div class="shadow-sm p-3 rounded-circle">
              ...
              <div class="col-md-12 col-lg-6 col-xl-4 col-sm-12">
                    <div class="card dashboard-top-plan">
                        <div class="card-body shadow-sm">
                            ...
                            <div class="row">
                                <div class="col d-flex justify-content-between">
                                    <h2 class="font-weight-bold top-heading mb-0 align-self-center">{{$vendor_count}}</h2>
                                    <div class="shadow-sm p-3 rounded-circle">
                                ...
                                <table class="table">
                                    ...
                                    @foreach ($vendors as $customer)
                                        <tr>
                                            ...
                                            <td>@if($customer['status'] == 1)<span class="text-center" style="background-color:#588E43; padding: 10px 15px 15px 15px; color: #fff;"><i class="fa fa-check"></i> </span>@else<span class="text-center" style="background-color:#bd2130; padding: 10px 15px 15px 15px; color: #fff;"><i class="fa fa-times"></i> </span>@endif</td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
                        ...
                        <div class="py-4">
                            ...
                            <ul class="list-unstyled recent-messages">
                               ...
                               @foreach($vendor_msg as $vendor_msg1)
                                <li class="media">
                                    <img class="img-fluid mr-3" src="{{ asset( 'storage/profile/vendors/'.$vendor_msg1->vendor_image.'' ) }}" alt="">
                                    <div class="media-body">
                                        ...
                                        <section class="d-flex justify-content-between align-items-center">
                                            ...
                                            <button type="button" class="btn btn-success" disabled=""> 
                                             Replied </button>
                                             @else
                                             <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModall{{ $vendor_msg1->id }}"> 
                                             Reply </button>
                                            ...
                                            <div class="modal fade" id="exampleModall{{ $vendor_msg1->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                              <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-body">
                                                   ...
                                                   {{ csrf_field() }}
                                                    <input type="hidden" name="reply_id" value=" {{ $vendor_msg1->id}}"> 
                                                    <input type="hidden" name="vendor_id" value=" {{ $vendor_msg1->vendor_id}}"> 
                                                    <input type="hidden" name="created_at" value=" {{ $vendor_msg1->created_at}}"> 
                                                    ...
                                                    <ul class="list-unstyled recent-messages" style="font-size: 15px;">
                                                     <li class="media"><p>Subject : {{ $vendor_msg1->subject }}<br> Message :  {{ $vendor_msg1->msg }}</p></li>
                                                 </ul>
                            ...
                            <div class="px-4">
                                ...
                                <a href="{{ route('admin.vendors.messages') }}" class="btn btn-warning">See More</a>
                                @elseif($vendor_msg_count==0 && $type==2)
                                <a href="{{ route('subadmin.vendors.messages') }}" class="btn btn-warning">See More</a>
                                @elseif($vendor_msg_count!=0 && $type==2)
                                <a href="{{ route('subadmin.admin_notification') }}" class="btn btn-warning">See More</a>
                                @else
                                <a href="{{ route('admin.admin_notification') }}" class="btn btn-warning">See More</a>
                                @endif
