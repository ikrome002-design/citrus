            ...
            <form action="{{ route('admin.business_type.store') }}" method="post" class="form" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="col-sm-12">
                        ...
                        <input type="text" name="title" id="title" placeholder="Business type" class="form-control"
                            value="{{ old('title') }}" required="">
                    </div>
                    <div class="col-sm-12">
                        <label for="parent">Status (Inactive : merchants can't add and product can't be shown in frontend)
                        </label>
