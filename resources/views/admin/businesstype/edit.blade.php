...
@section('content')
    ...
    <section class="content">
        ...
        <div class="text-end mb-3">
            <a href="{{ route('admin.business_type.destroy', $business_type->id) }}"
        ...
        <div class="card shadow-sm p-4 rounded-lg">
            ...
            <div class="tablist-content">
                <div class="tab-pane fade show active" id="tab-business" role="tabpanel" aria-labelledby="tab-business">
                    <form action="{{ route('admin.business_type.update', $business_type->id) }}" method="post"
                        ...
                        <div class="form-row">
                            <div class="col-sm-12">
                                ...
                                <input type="text" name="title" id="title" placeholder="Business type"
                                    class="form-control" value="{{ $business_type->title }}" required="">
                            </div>
                            <div class="col-sm-12">
