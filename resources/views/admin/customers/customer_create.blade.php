...
@section('content')
    ...
    <section class="content">
        ...
        <div class="card shadow-sm p-4 rounded-lg" style="max-width:650px;">
            <form action="{{ route('admin.customer-account') }}" method="post" class="form">
                        {{ csrf_field() }}
                        <h3 class=""><b>Create Customer Account</b></h3><br>
                        
                         
                      <input type="hidden" name="type" value="staff">
                      <input type="hidden" name="merchant_id" value="{{auth('employee')->user()->merchant_id}}">

                      <input type="hidden" name="staff_id" value="{{auth('employee')->user()->id}}">
