                    ...
                    <td style='vertical-align:top;font-size:12px;line-height:16px;font-family:Arial,sans-serif'>
                       <table id='m_-7134114449099840045m_5739355418147783239main' style='width:100%;border-collapse:collapse'>
                          <tbody>
                                    ...
                                    <tbody>
                                       <tr style='background-color:#93EB8B'>
                                          <td style='font-size:14px;padding:11px 18px 18px 18px;width:50%;vertical-align:top;line-height:16px;font-family:Arial,sans-serif'>
                                             <h1 style='color:#fff;line-height: 1;text-align: center;'>Citrus Stock Notification</h1>
                                          </td>
                                      ...
                                      <tbody>
                                         <tr>
                                            <td style='vertical-align:top;font-size:12px;line-height:16px;font-family:Arial,sans-serif padding: 0px 18px 0px 20px;'>
                                               ...
                                               <br/>
                                               <h4 style='margin:5px 0 0 0;font:12px/16px Arial,sans-serif'> Thank you for using our application!</h4>
                                            </td>
                                         </tr>
                                         <tr>
                                            <td style='vertical-align:top;font-size:12px;line-height:16px;font-family:Arial,sans-serif'>
                             ...
                             <tr>
                              <td style='vertical-align:top;font-size:12px;line-height:16px;font-family:Arial,sans-serif padding: 0px 18px 0px 20px;'>
                                 <h3 style='font-size:18px;color:#206080;font-weight:600;padding: 20px 15px;line-height: 1;background: #ddddddb5'>Your product stock reach to minimum limit.Please check and refill your stock.</h3>
                              </td>
                           </tr>     
                              <tr>
                              <td style='vertical-align:top;font-size:12px;line-height:16px;font-family:Arial,sans-serif;'>
                                 <table style='width:100%;border-collapse:collapse; margin-bottom: 12px !important;'>
                                    <tbody>
                                      <tr>
                                          <td style='padding-left: 15px;vertical-align:top;font-size:14px;line-height:16px;font-weight:bold;color:#206080;font-family:Arial,sans-serif'>Product ID : # {{ $mailData['product_id'] }}  
                                          </td>
                                       </tr>
                                       <tr>
                                          <td style='padding-left: 15px;vertical-align:top;font-size:14px;line-height:16px;font-weight:bold;color:#206080;font-family:Arial,sans-serif'> Product Name : {{ $mailData['product_name'] }}  
                                          </td>
                                       </tr>
                                       
                                       
                                       <tr>
                                          <td style='padding-left: 15px;vertical-align:top;font-size:14px;line-height:16px;font-weight:bold;color:#206080;font-family:Arial,sans-serif'> Product Sku : {{ $mailData['product_sku'] }}  
                                          </td>
                                       </tr>
