...
@section('content')
    ...
    <section class="container-fluid">
        <h3 class="mb-3">Edit Subadmin</h3>
        @include('layouts.errors-and-messages')
        <div class="card shadow-sm p-4 rounded-lg" style="max-width:650px;">
            <form action="{{ route('subadmin.update', $employee->id) }}" method="post" class="form" enctype="multipart/form-data">
                <div class="card-body">
                 ...
                 <div class="form-group text-center">
                   ...
                   @if($employee->status == 1 )
                    ...
                    @endif
                    <div class="mt-3">
                        <button type="submit" class="btn btn-success">Update Subadmin</button>
                    </div>
                </div>
