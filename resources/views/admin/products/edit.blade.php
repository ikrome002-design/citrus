                            ...
                            <div class="form-row">
                                @foreach($images as $image)
                                    <div class="col-md-3">
                                        ...
                                        <a onclick="return confirm('Are you sure?')" href="@if(isset(auth('employee')->user()->id)){{ route('admin.product.remove.thumb', ['src' => $image->src]) }} @elseif(isset(auth('vendor')->user()->id)){{ route('product.remove.thumb', ['src' => $image->src]) }}@endif" class="btn btn-danger btn-sm btn-block">Remove?</a><br />
                                    </div>
                                @endforeach
                            </div>
