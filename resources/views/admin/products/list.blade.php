    ...
    <section class="content">
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="card">
                    <a href="{{ route('admin.products.index') }}" ><div class="card-body shadow-sm">
                        <div class="row">
                            <div class="col-auto">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card">
                    <a href="{{ route('admin.categories.index') }}"><div class="card-body shadow-sm">
                        <div class="row">
                            <div class="col-auto">
                                <div class="shadow-sm p-3 rounded-circle">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6 text-md-right">
                            <a href="{{ route('admin.import') }}" class="btn btn-white border"><i class="fa fa-upload"></i> Import</a>
                            <a href="{{ route('admin.export') }}" class="btn btn-white border"><i class="fa fa-download"></i> Export</a>
                        </div>
                    </div>
