...
<section class="content">
  ...
  <form action="{{ route('admin.staff.staffVendorAdd') }}" method="post" enctype="multipart/form-data" id="VendorRegisterForm">
    {{ csrf_field() }}
...
policies.
  ...
  <form action="{{ route('admin.staff.staffVendorSave') }}" method="post" enctype="multipart/form-data" id="VendorRegisterForm1">
    {{ csrf_field() }}
