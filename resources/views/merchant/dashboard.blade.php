                ...
                <div class="col-lg-8">
                    <div class="row">
                        ...
                        <div class="col-xxl-4 col-md-6 mb-3">
                            <div class="card p-3">
                                <div class="card-body">
                                    <h5 class="card-title mb-3 mb-3 text-secondary fw-bolder">Sales <span
                                            class="text-muted fw-lighter h6">| Today</span>
                                    </h5>
                        ...
                        <div class="col-12 mb-3">
                            <div class="card p-3">
                                <div class="card-body">
                                    <h5 class="card-title mb-3 text-secondary fw-bolder">Sales <span
                        ...
                        <div class="col-12 mb-3">
                            <div class="card top-selling overflow-auto">
                                ...
                                <div class="card-body pb-0">
                                    <h5 class="card-title text-secondary fw-bolder">Recent Sales</h5>
                        ...
                        <div class="col-12">
                            <div class="card top-selling overflow-auto">
                                ...
                                <div class="card-body pb-0">
                                    <h5 class="card-title text-secondary fw-bolder">Top Selling Products</h5>
