...
<div class="section">
   <div class="">
      <div class="bg-primary text-center text-white">
         <h2 class="pt-5 font-weight-bold text-green">BuyVi.ca Membership Plans</h2>
...
<div id="plan_section">
  <div class="container">
    ...
    <form action="{{ route('vendor.register') }}" method="post" enctype="multipart/form-data" id="VendorRegisterForm">
      {{ csrf_field() }}
        ...
        <div class="col-lg-8 col-md-6 mb-3">
          <div class="card border shadow-sm">
            <div class="card-body register-form-step active" form-step="1" id="step-1">
              <h3 class="heading-primary">Vendor Registration</h3>
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" id="MissionStatement" rows="3" name="mission_description">{{ old('mission_description') }}</textarea>
              </div>
              <div class="form-group">
                ...
                <textarea class="form-control" id="ForYourBusiness" rows="3" name="do_for_you">{{ old('do_for_you') }}</textarea>
              </div>
              <h5> Is your business eligible to advertise on BuyVi.ca?</h5>
              {{--<div class="form-group mt-4">
                  <p>Is your business eligible to promote and sell on BuyVi.ca?<span class="text-danger">*</span></p>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="own_by_vancouver" id="businessOwnYes" value="1" checked="checked">
                    <label class="form-check-label" for="businessOwnYes">Yes</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="own_by_vancouver" id="businessOwnNo" value="0" >
            ...
            <div class="card-body register-form-step" form-step="2" id="step-2">
              ...
              <div class="form-row">
                <div class="col-md-6 my-3">
                  ...
                  <input type="email" class="form-control is-email" name="email" id="vendorEmail" value="{{ old('email') }}">
                </div>
                <input type="hidden" name="payment_status" value="1">
                <div class="col-md-6 my-3">
                  <label for="vendorEmail">Choose Password<span class="text-danger">*</span></label>
                  <input type="password" class="form-control is-password" name="password" id="vendorPassword" value="{{ old('password') }}">
                </div>
                <div class="col-md-6 my-3">
                  <label for="BusinessName">Business Name<span class="text-danger">*</span></label>
                  <input type="text" class="form-control" name="business_name" id="BusinessName" value="{{ old('business_name') }}">
                </div>
                <div class="col-md-6 my-3">
                  <label for="YearinBusiness">In what year did your business begin? <span class="text-danger">*</span></label>
                  <input type="text" class="form-control is-year" name="business_year" id="YearinBusiness" placeholder="e.g. 2021" value="{{ old('business_year') }}">
                </div>
                <div class="col-md-6 my-3">
                  <label for="OwnerName">Owner's Name<span class="text-danger">*</span></label>
                  <input type="text" class="form-control" name="name" id="OwnerName" value="{{ old('name') }}">
                </div>
                <div class="col-md-6 my-3">
                  <label for="ManagerName">Manager Name<span class="text-danger">*</span></label>
                  <input type="text" class="form-control gstCls" name="manager_name" id="ManagerName" value="{{ old('manager_name') }}">
                </div>
                <div class="col-md-6 my-3">
                  <label for="GSTNO">GST No.</label>
                  <input type="text" class="form-control gstCls" name="gst_no" id="GSTNO" value="{{ old('gst_no') }}">
                </div>
                <div class="col-md-6 my-3">
                  <label for="PSTNO">PST No.</label>
                  <input type="text" class="form-control gstCls" name="pst_no" id="PSTNO" value="{{ old('pst_no') }}">
                </div>
                <div class="col-12 my-3">
                  <label for="OfficeAddress">Office Storefront address<span class="text-danger">*</span></label>
                  <input type="text" class="form-control" name="address" id="OfficeAddress" value="{{ old('address') }}">
                </div>
                <div class="col-md-6 my-3">
                  <label for="OfficeCity">City<span class="text-danger">*</span></label>
                  <input type="text" class="form-control" name="city" id="OfficeCity" value="{{ old('city') }}">
                </div>
                <div class="col-md-6 my-3">
                  <label for="OfficeState">Province<span class="text-danger">*</span></label>
                  <input type="text" class="form-control" name="state" id="OfficeState" value="{{ old('state') }}">
                </div>
                <div class="col-md-4 my-3">
                  <label for="PostalCode">Postal Code<span class="text-danger">*</span></label>
                  <input type="text" class="form-control" name="postal_code" id="PostalCode" value="{{ old('postal_code') }}">
                </div>
                <div class="col-md-4 my-3">
                  <label for="OfficeNumber">Office Number<span class="text-danger">*</span></label>
                  <input type="text" class="form-control is-number" name="office_number" id="OfficeNumber" value="{{ old('office_number') }}">
                </div>
                <div class="col-md-4 my-3">
                  <label for="CellNumber">Cell Number<span class="text-danger">*</span></label>
                  <input type="text" class="form-control is-number" name="cell_number" id="CellNumber" value="{{ old('cell_number') }}">
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" value="1" name="same_office_add" id="BillingAddressSame">
                ...
                <div id="vendor-billing-address" class="col-12">
                  <div class="row">
                    <div class="col-12 my-3">
                      ...
                      <input type="text" class="form-control" name="billing_address" id="BillingAddress" value="{{ old('billing_address') }}">
                    </div>
                    <div class="col-md-6 my-3">
                      <label for="BillingCity">City<span class="text-danger">*</span></label>
                      <input type="text" class="form-control" name="billing_city" id="BillingCity" value="{{ old('billing_city') }}">
                    </div>
                    <div class="col-md-6 my-3">
                      <label for="BillingState">Province<span class="text-danger">*</span></label>
                      <input type="text" class="form-control" name="billing_state" id="BillingState" value="{{ old('billing_state') }}">
                    </div>
                    <div class="col-md-4 my-3">
                      <label for="BillingPostalCode">Postal Code<span class="text-danger">*</span></label>
                      <input type="text" class="form-control" name="billing_postal_code" id="BillingPostalCode" value="{{ old('billing_postal_code') }}">
                    </div>
                    <div class="col-md-4 my-3">
                      <label for="BillingOfficeNumber">Office Number<span class="text-danger">*</span></label>
                      <input type="text" class="form-control is-number" name="billing_office_number" id="BillingOfficeNumber" value="{{ old('billing_office_number') }}">
                    </div>
                    <div class="col-md-4 my-3">
                      <label for="BillingCellNumber">Cell Number<span class="text-danger">*</span></label>
                      <input type="text" class="form-control is-number" name="billing_cell_number" id="BillingCellNumber" value="{{ old('billing_cell_number') }}">
                    </div>
                  </div>
                </div>
              </div>
              <button type="button" class="btn btn-secondary btn-lg" id="GoToStep1">Back</button>
              <button type="button" class="btn btn-success btn-lg" id="GoToStep3">Continue</button>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 mb-3">
          <div class="card shadow-sm border">
            <div class="card-body">
              ...
              <hr class="my-4" />
              <div class="form-group">
                <label for="selectPlanVariant">Select Plan Type<span class="text-danger">*</span></label>
                <select name="plan_variant" class="custom-select mr-sm-2" id="selectPlanVariant">
              ...
              <div class="my-3 row text-center" id="planVariantMonthly">
                <div class="col-12">
                  <p id="planVariantName" style="font-weight: bold;">Monthly Subscription</p>
                </div>
                <div class="col-6 text-left">
                  <small>Initial price</small>
                  <p class="heading-primary">{{config('cart.currency_symbol')}}{{ $plan->monthly_initial_price }}</p>
                </div>
                <div class="col-6 text-right">
                  <small>Recurring price</small>
                  <p class="heading-primary"><del style="color:black">{{config('cart.currency_symbol')}}{{ $plan->monthly_recurring_price }}</del></p>
                </div>
                <div class="col-12">
                  <hr class="my-4" />
                </div>
              ...
              <div class="my-3 row text-center d-none" id="planVariantYearly">
                <div class="col-12">
                  <p id="planVariantName" style="font-weight: bold;">Yearly Subscription</p>
                </div>
                <div class="col-6 text-left">
                  <small>Initial price</small>
                  <p class="heading-primary text-left">{{config('cart.currency_symbol')}}{{ $plan->yearly_initial_price }}</p>
                </div>
                <div class="col-6 text-right">
                  <small>Recurring price</small>
                  <p class="heading-primary text-right"><del style="color:black">{{config('cart.currency_symbol')}}{{ $plan->yearly_recurring_price }}</del></p>
                </div>
                <div class="col-12">
                  <hr class="my-4" />
                </div>
