            ...
            <div class="card col-xl-4 col-lg-6 col-md-8 col-sm-10 mx-auto form p-4 mt-5 rounded-0">
                ...
                <div class="px-2">
                   <img src="{{ url('images/round-logo.svg') }}" alt="Italian Trulli" class="admin_login center mb-4">
                    <form action="{{ route('vendor.resetpassword') }}" method="post" class="justify-content-center">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12 text-center">
                                <a class="" href="{{ route('vendor.login') }}" class="text-center"><i class="fa fa-arrow-left" aria-hidden="true"></i> Login here</a>
                            </div>
                        </div>
                    </form>
                </div>
