            ...
            <div class="card col-xl-4 col-lg-6 col-md-8 col-sm-10 mx-auto form p-4 mt-5 rounded-0">
                <div class="px-2">
                   <!-- <img src="{{ url('images/round-logo.svg') }}" alt="Italian Trulli" class="admin_login center mb-4"> -->
                    ...
                    <form action="{{ route('admin.staff_login') }}" method="post" class="justify-content-center">
                        @else
                    <form action="{{ route('admin.login') }}" method="post" class="justify-content-center">
                        @endif
                         {{ csrf_field() }}
                        <h2 class="card-heading mb-3 text-center text-primary" style="font-size:36px;font-weight: 500px;"> @if(Request::segment(1) =='staff') Staff Login @else Admin Login @endif</h2>
