<header class="main-header position-fixed top-0 w-100">

    <a href="{{ env('APP_URL') }}" class="logo">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini" style="color: #fff; font-size:25px;">C</span>
            ...
            <ul class="nav navbar-nav">
                ...
                {{-- <li class="dropdown user user-menu">
                    ...
                    <a href="javascript:void(0)" class="text-white" data-toggle="dropdown">
                        @if ($user->avatar != '')
                            <img class="user-image1" src="{{ asset('storage/profile/users/' . $user->avatar . '') }}"
                    ...
                    <ul class="dropdown-menu mt-3">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                ...
                                @elseif(Request::segment(2) == 'subadmin')
                                    <a href="{{ route('admin.subadmin_profile') }}"
                                        class="btn btn-info btn-flat">Profile</a>
                                @else
                                    <a href="{{ route('admin.staffs.profile') }}"
                                        class="btn btn-info btn-flat">Profile</a>
                                @endif
                            </div>
                            <div class="pull-right">
                                ...
                                @elseif(Request::segment(2) == 'subadmin')
                                    <a href="{{ route('subadmin.logout') }}" class="btn btn-danger btn-flat">Sign
                                        out</a>
                                @else
