...
<head>
    ...
    <link rel="icon" type="image" href="{{ asset('assets/images1/faviocn.png') }}">
...
<header>
	<div class="container">
		<nav class="navbar navbar-expand-lg navbar-light px-0">
		  <a class="navbar-brand" href="{{ route('home') }}"><img src="{{ asset('assets/images1/logo.png')}}"></a>
		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
		    <ul class="navbar-nav mx-auto">
		      ...
		      @if(auth('vendor')->check())
		       <li class="nav-item">
		        <a class="nav-link" href="{{route('vendor.dashboard')}}">My Acccount</a>
		      </li>
		      <li class="nav-item">
		        <a class="nav-link" href="{{ route('vendor.logout') }}">Logout</a>
		      </li>
		     @elseif(auth()->check())
		       <li class="nav-item">
		        <a class="nav-link" href="{{ route('accounts', ['tab' =>'v-pills-account-details']) }}">My Account</a>
		      </li>
		  ...
		  <li class="nav-item">
		       ...
		       <li class="nav-item dropdown">
		        ...
		        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
		          ...
		          <a class="dropdown-item" href="{{route('vendor.login')}}">Merchant Login</a>
			...
			@foreach($banner_contents as $banner) 
			    <div class="item">
			    	<div class="row align-items-center">
			      		...
			      		<div class="col-md-6 col-lg-6 col-12">
			      			<div class="slide-img">
			      				<figure><img src="{{ asset('storage/banners/'.$banner->banner_image.'')}}"></figure>
			      			</div>
			      		</div>
			      	</div>
			    </div>
		...
		<div class="row py-5">
			<div class="col-md-12 col-lg-12 col-xl-12 text-center pt-4">
				<div class="categorie-text">
					...
					<p class="custom-p">There are a lot of categories in which you can sell or buy your desired products services. We hope you will get maximum from our side. Enjoy!</p>
				</div>
			</div>
			<div class="col-md-12 col-lg-12 col-xl-12 text-center">
				...
				<!-- <div id="categorie-Toggle">
					<ul class="categorie-list mt-1">
					   	<li><a href="javascript:void(0)">Salon</a></li>
                        <li><a href="javascript:void(0)">Market</a></li>
                        <li><a href="javascript:void(0)">Electronic Shop</a></li>
                        <li><a href="javascript:void(0)">Home and Kitchen</a></li>
                        <li><a href="javascript:void(0)">Hardware</a></li>
                        <li><a href="javascript:void(0)">Video Games</a></li>
                        <li><a href="javascript:void(0)">Auto Garage and Parts</a></li>
                        <li><a href="javascript:void(0)">Arts and Craft</a></li>
                        <li><a href="javascript:void(0)">School</a></li>
                        <li><a href="javascript:void(0)">Home And Apartment</a></li>
                        <li><a href="javascript:void(0)">Carwash</a></li>
                        <li><a href="javascript:void(0)">Supermarket</a></li>
                        <li><a href="javascript:void(0)">Law Firm</a></li>
					</ul>
				</div> -->
				<div class="slider-arrow">			    
				    <div class="bar-head">
				        ...
				        <div class="arrow">
				            <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="chevron-down" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="svg-inline--fa fa-chevron-down fa-w-14 fa-3x">
		...
		<div class="row align-items-center">
			<div class="col-md-6 col-lg-6 col-12">
				<div class="readyBox-text">
					...
					<p class="text-white">We’re busy putting the finishing touches on a truley unique experiance that will set you free to do anything.Want Instant Updates</p>
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-6 col-12">
				<div class="discovered-content">
					...
					<p>Shopping is about having fun, enjoying yourself, and taking life easy. It’s why we’ve built a powerful system that allows you to do exactly that:</p>
	...
	<div class="container">
		...
		<div class="row align-items-center my-5">
			...
			<div class="col-md-6 col-lg-6 col-12">
				...
				<p class="custom-p mt-2 mb-3">When it’s all about keeping your customers happy, there’s nothing better than giving them exactly what they want.Not sure what that is? We already know</p>
				<ul>
					...
					<li><strong>-Flexible Options</strong> allow you to accept PayPal, VISA, MasterCard and more</li>
				</ul>
			</div>
		</div>
		<div class="row align-items-center">
				...
				<div class="owl-carousel owl-theme testimony-slide">
				    ...
				    <div class="item">
				    	<div class="testimony-content text-center">
				    		<figure><img src="{{ asset('storage/testimonial/'.$testimonial->image.'')}}"></figure>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-lg-12 col-12 text-center">
				...
				<p class="custom-p mb-5">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
			</div>
...
?>
			<div class="col-md-6 col-lg-4 col-xl-4 col-12">
				<div class="card border-0">
					<img class="card-img-top" src="{{ asset('storage/blog/'.$blog->image.'')}}" alt="Card image cap">
					  <div class="card-body">
		...
		<div class="row">
			<div class="col-md-12 col-lg-6 col-12 px-0">
				<div class="contactBox-text">
					...
					<p class="contactText mb-5 mt-2">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
					<div class="contactaddress">
						<div class="contact-tileBox">
							<h3>ADDRESS</h3>
							<p>JKUAT Towers, 17th floor, Kenyatta Avenue, Nairobi, Kenya. P.O. Box 15168 - 00400, Nairobi.</p>
						</div>
						<div class="contact-tileBox">
